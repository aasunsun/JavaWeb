...
import com.bjpowernode.unils.FileNameUtil;
...
//    }
    ...
    public Object ajaxImg(MultipartFile pimage,HttpServletRequest request) {
        ...
        //转存 F:\web\web\big\3\mimissm\image_big
        try {
    ...
    public String save(ProductInfo info,HttpServletRequest request) {
        ...
        saveFileName = "";
        //增加成功后应重新访问数据库，所以跳转到分页显示的action上
    ...
    public String update(ProductInfo info,HttpServletRequest request) {
        ...
        // 实体类info使用的隐藏表单域提供上来的pImage原始图片的名称；
        ...
        //而下次更新时要使用这个变量作为依据，就会出错，所以必须清空saveFileName
        saveFileName = "";
